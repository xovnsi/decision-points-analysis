...
net_name = "running-example-Will-BPM-silent-loops-silent"
...
t_P = PetriNet.Transition("trans_P", "Evaluate Appeal")
t_Q = PetriNet.Transition("trans_Q", "Archive")
t_R = PetriNet.Transition("trans_R", None)
...
petri_utils.add_arc_from_to(p_10, t_Q, net)
petri_utils.add_arc_from_to(t_Q, sink, net)
petri_utils.add_arc_from_to(t_R, p_1, net)
...
t_Q.properties[petri_properties.TRANS_GUARD] = 'appeal == False'
t_Q.properties[petri_properties.READ_VARIABLE] = ['appeal']
t_Q.properties[petri_properties.WRITE_VARIABLE] = []

t_R.properties[petri_properties.TRANS_GUARD] = 'appeal == True'
t_R.properties[petri_properties.READ_VARIABLE] = ['appeal']
t_R.properties[petri_properties.WRITE_VARIABLE] = []
